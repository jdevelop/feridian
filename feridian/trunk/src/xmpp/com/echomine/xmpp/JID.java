 ...
 * An instantiated JID is immutable by default.
 */
public class JID {
    ...
    public static JID parseJID(String jidStr) throws ParseException {
        if (jidStr == null) throw new ParseException("JID cannot be null");
    ...
    /**
     * The value may possibly be a host name in canonical form (ie. www.blah.com)
     * or in IPv4 or IPv6 form.
     * 
