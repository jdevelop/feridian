 ...
 * will give you information such as the software client being used, the
 * version, and the OS the client is running on. This message seems to only work
 * with the server and not when you send it to a user (somehow not supported).
 * Thus, current implementation will not allow you to create a message that
...
public class VersionIQPacket extends IQPacket {
    ...
    /**
     * @return Returns the client software name, ie. Muse.
     */
