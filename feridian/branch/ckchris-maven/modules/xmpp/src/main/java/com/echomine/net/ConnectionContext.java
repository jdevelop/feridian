...
public class ConnectionContext {
     ...
     * @param port the port to connect to/receive from
     */
    public ConnectionContext(InetAddress host, int port) {
        this(host, port, null);
    }
     ...
     * @param port the port to connect to/receive from
     */
    public ConnectionContext(String hostname, int port) throws UnknownHostException {
     ...
     */
    public ConnectionContext(InetAddress host, int port, ConnectionThrottler throttler) {
        this.host = host;
        this.port = port;
     ...
     * @param throttler the bandwidth throttler, or null if no throttling
     */
    public ConnectionContext(String hostname, int port, ConnectionThrottler throttler) throws UnknownHostException {
    ...
    public boolean equals(Object obj) {
        ...
        if ((host == null && context.getHost() == null) && (port == context.getPort()) && (secure == context.isSSL()))
            return true;
        else if (host != null && host.equals(((ConnectionContext) obj).getHost()) && port == ((ConnectionContext) obj).getPort() && (secure == context.isSSL()))
            return true;
        return false;
    }
